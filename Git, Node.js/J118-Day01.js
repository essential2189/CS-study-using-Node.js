...
function check_array() {
    ...
    while (true) {
        var array = getInput(); var array_s = split_array(array);
        var array1 = array_s[0]; var array2 = array_s[1];
...
function straight(int_p, init_num, straight_cnt, straight_array) {
    ...
    return [straight_array, init_num, straight_cnt];
}

function loop_straight(c_arr, max_pair, max_triple, max_four, straight_cnt, straight_array, init_num) {
    for (const property in c_arr) {
        ...
        straight_result = straight(int_p, init_num, straight_cnt, straight_array);
        straight_array = straight_result[0]; init_num = straight_result[1]; straight_cnt = straight_result[2];
    }
...
function check_condition_all(array, c_arr) {
    ...
    const ordered = Object.keys(c_arr).sort().reduce(
        (obj, key) => {
            obj[key] = c_arr[key];
            return obj;
        },
    ...
    var result = loop_straight(c_arr, max_pair, max_triple, max_four, straight_cnt, straight_array, init_num)
    return result;
}
